-- ============================================================
-- GESTION SALAIRE — Schéma MySQL
-- Projet pédagogique — Madagascar
-- ============================================================

CREATE DATABASE IF NOT EXISTS gestion_salaire CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE gestion_salaire;
...
CREATE TABLE IF NOT EXISTS tranches_irsa (
  ...
  montant_max         DECIMAL(12,2),          -- NULL = illimité
...
CREATE TABLE IF NOT EXISTS bulletins_paie (
  ...
  periode                       VARCHAR(7)    NOT NULL,  -- ex: "2024-06"
  salaire_brut                  DECIMAL(12,2) NOT NULL,
...
CREATE INDEX idx_employes_dept       ON employes(departement_id);
...
CREATE INDEX idx_primes_type         ON primes(type);
CREATE INDEX idx_primes_employe      ON primes(employe_id);
CREATE INDEX idx_primes_departement  ON primes(departement_id);
CREATE INDEX idx_primes_actif        ON primes(actif);
